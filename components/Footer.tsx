    ...
    <footer className="border-t border-border bg-bg">
      <div className="mx-auto max-w-[1200px] px-6 py-10">
          ...
          <div className="flex gap-10 sm:gap-14">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-text-secondary">
                ...
                <li><a href="mailto:cho@yoongjae.com" className="hover:text-text-primary transition-colors">Contact</a></li>
                <li>
                ...
                <li>
                  <a href="https://www.threads.com/@ilmagnificho" target="_blank" rel="noopener noreferrer"
                     className="hover:text-text-primary transition-colors">Threads</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="border-t border-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-text-secondary/50">© 2026 Bibimb.ai · TETRA Corp.</p>
